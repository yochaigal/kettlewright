...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const setBackgroundDescription = (background) => {
    ...
    const description = backgroundData[background]?.background_description ?? "";
  ...
  const updateTraitsDescription = () => {
    ...
    const description = `You have a ${traits[0].value} ${traits[0].name}, ${traits[1].value} ${traits[1].name}, and ${traits[2].value} ${traits[2].name}. 
